defmodule Explorer.PolarsBackend.Native do
  ...
  def s_from_list_of_lists_i64(_name, _val), do: err()
  def s_from_list_of_lists_f64(_name, _val), do: err()
  def s_from_list_of_lists_str(_name, _val), do: err()
  def s_from_list_of_lists_bool(_name, _val), do: err()
