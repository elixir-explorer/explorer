defmodule Explorer.PolarsBackend.Native do
  ...
  def df_mutate(_df, _columns), do: err()
  ...
  def s_fill_missing_with_bin(_s, _strategy), do: err()
  def s_fill_missing_with_float(_s, _strategy), do: err()
  def s_fill_missing_with_int(_s, _strategy), do: err()
