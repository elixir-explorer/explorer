defmodule Explorer.PolarsBackend.Native do
  ...
  def s_contains_literal(_s, _pattern), do: err()
  ...
  def s_to_lowercase(_s), do: err()
  def s_to_iovec(_s), do: err()
  def s_to_uppercase(_s), do: err()
