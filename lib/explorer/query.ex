...
defmodule Explorer.Query do
  ...
  iris dataset, you could write this:
      ...
      #Explorer.DataFrame<
        Polars[150 x 5]
        sepal_length float[64] [-1.0840606189132322, -1.3757361217598405, -1.66741162460645, -1.8132493760297554, -1.2298983703365365, ...]
        sepal_width float[64] [2.3722896125315045, -0.28722789030650403, 0.7765791108287005, 0.2446756102610982, 2.9041931130991068, ...]
        petal_length float[64] [-0.757639168744384, -0.757639168744384, -0.789760671093637, -0.7255176663951308, -0.757639168744384, ...]
        petal_width float[64] [-1.714701435665471, -1.714701435665471, -1.714701435665471, -1.714701435665471, -1.714701435665471, ...]
  ...
  the mean per species, you could write:
      ...
      #Explorer.DataFrame<
        ...
        sepal_length_mean float[64] [5.005999999999999, 5.936, 6.587999999999998]
        sepal_width_mean float[64] [3.4180000000000006, 2.7700000000000005, 2.9739999999999998]
        petal_length_mean float[64] [1.464, 4.26, 5.552]
        petal_width_mean float[64] [0.2439999999999999, 1.3259999999999998, 2.026]
      >
  ...
  average, using a filter on the column name, one could write:
      ...
      #Explorer.DataFrame<
        Polars[70 x 5]
        sepal_length float[64] [7.0, 6.4, 6.9, 6.5, 6.3, ...]
        sepal_width float[64] [3.2, 3.2, 3.1, 2.8, 3.3, ...]
        petal_length float[64] [4.7, 4.5, 4.9, 4.6, 4.7, ...]
        petal_width float[64] [1.4, 1.5, 1.5, 1.5, 1.6, ...]
